...
void ambassadorTest1(struct gameState state) {
	...
	// discard choice1
	int choice1CountExpected = getHandCount(state.whoseTurn, choice1Card, state) - 1;
	...
	assert("Card instances in hand -1.", getHandCount(state.whoseTurn, choice1Card, state), choice1CountExpected);
	...
	assert("Card instances in hand +1.", getHandCount(state.whoseTurn + 1, choice1Card, state), nextPlayerChoice1CountExpected);
...
void ambassadorTest3(struct gameState state) {
	...
	// discard choice1 (0)
	int choice1CountExpected = getHandCount(state.whoseTurn, choice1Card, state);
	state.discardCount[state.whoseTurn] = 0;
	int discardCountExpected = state.discardCount[state.whoseTurn]; // to supply not discard
	...
	assert("Number of cards in discard unchanged.", state.discardCount[state.whoseTurn], discardCountExpected);
	assert("Card instances in hand unchanged.", getHandCount(state.whoseTurn, choice1Card, state), choice1CountExpected);
...
void ambassadorTest4(struct gameState state) {
	...
	assert("Card instances in hand unchanged.", getHandCount(state.whoseTurn + 1, choice1Card, state), nextPlayerChoice1CountExpected);
...
void ambassadorTest5(struct gameState state) {
	...
	state.handCount[state.whoseTurn + 1] = 0;
	int nextPlayerHandExpected = state.handCount[state.whoseTurn + 1];
	int nextPlayerChoice1CountExpected = getHandCount(state.whoseTurn + 1, choice1Card, state);
	int supplyCountExpected = state.supplyCount[choice1Card];
	...
	assert("Number of cards in discard unchanged.", state.discardCount[state.whoseTurn], discardCountExpected);
	assert("Card instance in hand unchanged.", getHandCount(state.whoseTurn, choice1Card, state), choice1CountExpected);
